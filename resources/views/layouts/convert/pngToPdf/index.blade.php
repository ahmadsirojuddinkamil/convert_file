<div style="background-color: #F3F0EC">
    <div class="text-center container py-5 pl-5">
        ...
        <div>
            <form action="/png_to_pdf" method="POST" enctype="multipart/form-data">
                @csrf

                <label for="png-to-pdf" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Select Png
                    File</label>
