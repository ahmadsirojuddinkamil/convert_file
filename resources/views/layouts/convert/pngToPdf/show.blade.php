<div style="background-color: #F3F0EC">
    <div class="text-center container py-5 pl-5">
        ...
        <div>
            ...
            <p>Convert your PNG To PDF documents with incredible accuracy.</p>
        ...
        <div>
            <form action="" method="POST" enctype="multipart/form-data" id="reply-jpg-to-pdf">
                ...
                <label for="png-to-pdf" class="btn btn-secondary text-white px-5 py-3 rounded-pill">Select Jpg
                    File</label>
                <input id="png-to-pdf" type="file" name="file" style="display: none" accept="image/png"
                ...
                @foreach ($findAndGetDataFile as $resultPdf)
                    <li>
                        <ul>
                            ...
                            <a href="/png_to_pdf/{{ $resultPdf->unique_id }}/download"
...
<script>
    ...
    if (checkOwnershipAndGetValue) {
        document.getElementById('reply-jpg-to-pdf').action = `/png_to_pdf/${checkOwnershipAndGetValue}/reply`;
    }
</script>
