    ...
    <div class="container pt-5 pb-4">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mt-4 text-light">HightConvert adalah website penyedia layanan convert extensi file secara
                    gratis!</p>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="text-white mt-4 d-flex flex-column contact-link">
                    <a href="#" class="py-3 text-light border-bottom border-primary"><i
                            class="fas fa-envelope text-secondary me-2"></i> ahmadsirojuddinkamil@gmail.com</a>
                    <a href="https://ahmadsirojudinkamil.blogspot.com/"
                        class="py-3 text-light border-bottom border-primary"><i
                            class="fa fa-id-card text-secondary me-2"></i> ahmadsirojudinkamil</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-6 text-center text-md-start">
                <span class="text-light"><a href="#" class="text-secondary"><i
                            class="fas fa-copyright text-secondary me-2"></i>Ahmad Sirojuddin Kamil</a></span>
            </div>
        </div>
    </div>
</div>
