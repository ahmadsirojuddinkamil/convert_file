...
<div style="background-color: #F3F0EC">
    <div class="text-center container py-5 pl-5">
        ...
        <div>
            <form action="" method="POST" enctype="multipart/form-data" id="reply-png-to-pdf">
                @csrf
                    ...
                    <li>
                        <ul>
                            ...
                            <li style="list-style-type: none;">
                                <img src="{{ asset('storage/' . $pdf->preview) }}" alt="" height="150px" width="150px">
                            </li>

                            <a href="/png-to-pdf/{{ $pdf->uuid }}/download"
